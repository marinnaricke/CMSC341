...
private:  // this private BinaryNode is within BST
	...
	{
	  return (numNodes(t->left)+ numNodes(t->right));
	}
    }
    ...
    */
    ...
    // Printing the tree preOrder (NLR)
    /*void printTree( BinaryNode *t, ostream & out) const
    {
      if (t != NULL)
	{
    ...
    */
    ...
    // Printing the tree postOrder (LRN)
    void printTree( BinaryNode *t, ostream & out) const
    {
      if (t != NULL)
	{
